...
namespace LasyBastardEngineer.Achievements
{
    ...
    class DrifterSkinUnlockAchievement : ModdedUnlockableAndAchievement<CustomSpriteProvider>
    {
        public override String AchievementIdentifier { get; } = "DRIFTER_SKINUNLOCKABLE_ACHIEVEMENT_ID";
        public override String UnlockableIdentifier { get; } = "DRIFTER_SKINUNLOCKABLE_REWARD_ID";
        public override String PrerequisiteUnlockableIdentifier { get; } = "";
        public override String AchievementNameToken { get; } = "DRIFTER_SKINUNLOCKABLE_ACHIEVEMENT_NAME";
        public override String AchievementDescToken { get; } = "DRIFTER_SKINUNLOCKABLE_ACHIEVEMENT_DESC";
        public override String UnlockableNameToken { get; } = "DRIFTER_SKINUNLOCKABLE_UNLOCKABLE_NAME";
        protected override CustomSpriteProvider SpriteProvider { get; } = new CustomSpriteProvider("");

        int requiredChainDashCount = 100;
